...
const deleteCategories_1 = require("./app/useCases/categories/deleteCategories");
...
//Delete category
exports.router.delete('/categories/:categoryId', deleteCategories_1.deleteCategories);
// List Products
exports.router.get('/products', listProducts_1.listProduct);
// Create Product
